...
class _HomePageState extends State<HomePage> {
  ...
  final User? currentUser = FirebaseAuth.instance.currentUser; // Current logged-in user
  bool _isCreating = false; // Flag to track if the group is being created
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: AppDrawer(currentUser: currentUser), // Use the AppDrawer here
      body: Padding(
